...
import { TargetDisplaySize } from 'amazon-chime-sdk-js/build/videodownlinkbandwidthpolicy/TargetDisplaySize';
...
export class OpenWcAppProj extends LitElement {
  ...
  static styles = css`
    :host {
      ...
      margin: 0 auto;
      text-align: center;
      background-color: var(--open-wc-app-proj-background-color);
    }
  ...
  render() {
    return html`
      <main>
        ...
        <p>Edit <code>src/OpenWcAppProj.ts</code> and save to reload.</p>
        <a
          class="app-link"
